    ...
    <>
      <div className="mb-12 lg:w-1/2">
        <div className="rounded-2.5xl bg-white p-12 dark:bg-jacarta-700">
          ...
          <p className="mb-8 text-lg leading-normal dark:text-jacarta-300">
            Find us among the internet. We exist in multiple social media platform such as Twitter, Facebook, Instagram and more. If you interested in interacting
            inside the community, check our discord and telegram groups.
          </p>
      ...
      <div className="mb-12 lg:w-1/2">
        <div className="h-full rounded-2.5xl bg-white p-12 dark:bg-jacarta-700">
          ...
          <p className="mb-8 text-lg leading-normal dark:text-jacarta-300">
            Our mission is to gather like-minded people and give them avenue to connect, bond and enjoy their hobby not just in online space, but also real life.
          </p>
          <a
            href="#"
            className="inline-block rounded-full bg-accent py-3 px-8 text-center font-semibold text-white shadow-accent-volume transition-all hover:bg-accent-dark"
          >
            See our offline events
          </a>
        </div>
      </div>
